#!/bin/sh
#
# $Id: stuff.sh 18554 2021-06-13 00:05:10Z NiLuJe $
#
...
env -i -- setsid /usr/local/stuff/bin/stuff-daemons.sh &

# Launch literary clock
env -i -- setsid /usr/local/stuff/bin/litclock-start.sh &
